...
const SAMPLES: Record<string, number[]> = {
  ...
  'walk.stone':       [0.018, 0.45, 92, 0, 0.012, 0.035, 3, 2, -0.8, 0, 0, 0, 0, 0.05],
  'walk.wood':        [0.024, 0.38, 132, 0, 0.015, 0.045, 3, 1, -0.5, 0, 0, 0, 0, 0.04],
  'walk.salt':        [0.014, 0.72, 210, 0, 0.008, 0.025, 3, 3, -0.7, 0, 0, 0, 0, 0.03],
  'walk.grass':       [0.012, 0.85, 70, 0, 0.018, 0.04, 3, 4, -0.9, 0, 0, 0, 0, 0.03],
};
