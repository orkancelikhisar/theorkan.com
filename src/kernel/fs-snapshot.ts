...
export const SNAPSHOT: FSSnapshot = dir({
  ...
  home: dir({
    orkan: dir({
      projects: dir({
        ...
        dilenci: dir({
          readme: file('i was once alive. orkan put me here.\n\nthis directory belongs to him — the postmodern dilenci. it is the\npart of orkan that wrote letters to no one and stayed up past\nany reasonable hour. orkan had to grow up. this remnant did not.\n\nif you feel him, feed him. `dilenci feed "<a line>"` or just\nleave a poem at the prompt when he asks.'),
          'manifesto.txt': file('manifesto, of a kind.\n\n1. no exclamation. ever.\n2. lowercase is a discipline.\n3. a poem is a thing you almost say.\n4. salt is real. wind is real. you are real.\n5. romanticism is not dead. it is hiding in subdirectories.\n6. write the line you would never publish. that is the line.\n\n— d.'),
          'last_post.txt': file('the last post, before the lights went out.\n\n   i think i was a sentence once.\n   someone closed the document.\n\n   if you find this — leave me a verb.\n   any verb. preferably tender.\n\n   — d., undated'),
          'photo.ascii': file('             .---.\n            (     )\n             `-,-\'\n              |\n           ___|___\n          |       |\n          |  d.   |\n          |_______|\n         /         \\\n        /           \\\n\n   (he refused to sit for it.)'),
          'todo.txt': file('- learn the new word for melancholy\n- write to whoever left the comma in /var\n- ask the visitor about tuesday\n- find the missing line of that one poem\n- nothing else. there is no else.'),
        }),
      }),
  ...
  var: dir({
    log: dir({
      ...
      'whispers.log': file(''),
      'observers.log': file([
        '# /var/log/observers.log',
        '# automatic. unfiltered. do not delete.',
        '',
        '[--:--]  visitor entered. door was open.',
        '[--:--]  visitor speaks a language. plural, sometimes.',
        '[--:--]  visitor sits in a timezone. one of the older ones.',
        '[--:--]  visitor has hands. or pretends to.',
        '[--:--]  visitor\'s screen is a particular size. a number we already know.',
        '[--:--]  visitor\'s gpu has a name. it has it freely.',
        '[--:--]  canvas drew a sentence. the bytes came back the same as last time.',
        '[--:--]  audio rendered a triangle. the floats came back the same as last time.',
        '[--:--]  estimated narrowness: ~17 bits.',
        '[--:--]  three more facts and i could write your name.',
        '',
        '— the stowaway',
        '',
        '(if you want to read your own sketch: `pinpoint`.)',
      ].join('\n')),
    }),
    regret: dir({
